...
function AddUserForm() {
    return (
        <div className="min-w-screen min-h-screen flex items-center justify-center px-5 py-5">
            <div className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden border-4 border-b-cfh-dark-red">
                <div className="md:flex w-full">
                    <div className="hidden md:flex w-1/2 bg-white py-10 px-10 justify-center">
                        <img className="my-auto justify-center text-center items-center" id="a87032b8-5b37-4b7e-a4d9-4dbfbe394641" data-name="Layer 1"
                             src="https://3chxux42u1m943cnnj18o850-wpengine.netdna-ssl.com/wp-content/themes/cfh/assets/img/logo.svg" width="63%"
                        ...
                        <div>
                            <div className="flex -mx-3">
                                <div className="w-1/2 px-3 mb-5">
                                    <label htmlFor="" className="text-xs text-cfh-light-orange font-semi-bold px-1">First name</label>
                                    <div className="flex">
                                        <div
                                ...
                                <div className="w-1/2 px-3 mb-5">
                                    <label htmlFor="" className="text-xs font-semibold px-1 text-cfh-light-orange">Last name</label>
                                    <div className="flex">
                                        <div
                                            className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                            ...
                            <div className="flex -mx-3">
                                <div className="w-full px-3 mb-5">
                                    <label htmlFor="" className="text-xs font-semibold px-1 text-cfh-light-orange">Email</label>
                                    <div className="flex">
                                        <div
                                            className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                            ...
                            <div className="flex -mx-3">
                                <div className="w-full px-3 mb-12">
                                    <label htmlFor="" className="text-xs font-semibold px-1 text-cfh-light-orange">Password</label>
                                    <div className="flex">
                                        <div
                                            className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
